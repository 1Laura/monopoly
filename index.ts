interface MonopolyGame {
    ...
    price?: number; // Price for properties, railroads, and utilities
    rent?: number[]; // Rent tiers for properties and railroads
    houseCost?: number; // Cost of a house for properties
    hotelCost?: number; // Cost of a hotel for properties
    rentMultiplier?: number[]; // Rent multipliers for utilities
    description?: string; // Description for special squares
    amount?: number; // Amount for tax squares
}
